...
public class CustomtabDialog  extends Dialog {
    ...
    public CustomtabDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public CustomtabDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
     ...
     */
    public CustomtabDialog(Context context, float alpha, int gravity) {
        super(context);
